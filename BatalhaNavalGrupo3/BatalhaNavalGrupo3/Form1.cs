        ...
        private void Selecionar_navios(object sender, System.EventArgs e)
        {
            ...
            if (definindo_jogo == true)
            {
                if (Botao_Navio_Selecionado == 5)
                {
                    ...
                    lbl.BackColor = color;
                    Console.WriteLine(botao_ativo[0]);
                }
                ...
                {
                    if (color == System.Drawing.Color.Aqua & botao_ativo[2] <= 3 & botao_ativo_tres_contador == false)
                    {
                        if (botao_ativo[2] == 1)
                        {
                            color = System.Drawing.Color.Black;
                        ...
                        else if ((posicaoX_do_navio + tamanho_quadrados * (botao_ativo[2] - 1) == lbl.Location.X || posicaoX_do_navio - tamanho_quadrados * (botao_ativo[2] - 1) == lbl.Location.X) & posicaoY_do_navio == lbl.Location.Y)
                        {
                            color = System.Drawing.Color.Black;
                            quadradoMarcado[lbl.Location.X / tamanho_quadrados, lbl.Location.Y / tamanho_quadrados] = true; // Pela localização X e Y divididos pelo tamanho do quadrado chego no i e j.
                            botao_ativo[2] += 1;
                        ...
                        else if ((posicaoY_do_navio + tamanho_quadrados * (botao_ativo[2] - 1) == lbl.Location.Y || posicaoY_do_navio - tamanho_quadrados * (botao_ativo[2] - 1) == lbl.Location.Y) & posicaoX_do_navio == lbl.Location.X)
                        {
                            color = System.Drawing.Color.Black;
                            quadradoMarcado[lbl.Location.X / tamanho_quadrados, lbl.Location.Y / tamanho_quadrados] = true; // Pela localização X e Y divididos pelo tamanho do quadrado chego no i e j.
                            botao_ativo[2] += 1;
                    ...
                    else if (color == System.Drawing.Color.Aqua & botao_ativo[2] <= 3 & botao_ativo_tres_contador == true)
                    {
                        if (botao_ativo[2] == 1)
                        {
                            color = System.Drawing.Color.Black;
                ...
                {
                    if (color == System.Drawing.Color.Aqua & botao_ativo[3] <= 2)
                    {
                        if (botao_ativo[3] == 1)
                        {
                            color = System.Drawing.Color.Black;
                        ...
                        else if ((posicaoX_do_navio + tamanho_quadrados * (botao_ativo[3] - 1) == lbl.Location.X || posicaoX_do_navio - tamanho_quadrados * (botao_ativo[3] - 1) == lbl.Location.X) & posicaoY_do_navio == lbl.Location.Y)
                        {
                            color = System.Drawing.Color.Black;
                            quadradoMarcado[lbl.Location.X / tamanho_quadrados, lbl.Location.Y / tamanho_quadrados] = true; // Pela localização X e Y divididos pelo tamanho do quadrado chego no i e j.
                            botao_ativo[3] += 1;
                        ...
                        else if ((posicaoY_do_navio + tamanho_quadrados * (botao_ativo[3] - 1) == lbl.Location.Y || posicaoY_do_navio - tamanho_quadrados * (botao_ativo[3] - 1) == lbl.Location.Y) & posicaoX_do_navio == lbl.Location.X)
                        {
                            color = System.Drawing.Color.Black;
                            quadradoMarcado[lbl.Location.X / tamanho_quadrados, lbl.Location.Y / tamanho_quadrados] = true; // Pela localização X e Y divididos pelo tamanho do quadrado chego no i e j.
                            botao_ativo[3] += 1;
